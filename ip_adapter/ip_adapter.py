...
class IPAdapter:
    ...
    def get_image_embeds(self, pil_image=None, clip_image_embeds=None):
        ...
        # print(f'clip image:{clip_image_embeds.shape}')
        image_prompt_embeds = self.image_proj_model(clip_image_embeds)
        bsz,seq_len,dim = image_prompt_embeds.shape
        image_prompt_embeds = image_prompt_embeds.view(1, bsz * seq_len, dim)
        # print(f'image embed:{image_prompt_embeds.shape}')
        uncond_image_prompt_embeds = self.image_proj_model(torch.zeros_like(clip_image_embeds))
        uncond_image_prompt_embeds = uncond_image_prompt_embeds.view(1, bsz * seq_len, dim)
        # print(f'uncond embed:{uncond_image_prompt_embeds.shape}')
...
class StoryAdapterXL(IPAdapter):
    """SDXL"""
    ...
    def generate(
        ...
        **kwargs,
        ...
        if prompt is None:
            ...
            prompt = "best quality, high quality, comic " + prompt + " . graphic illustration, comic art, graphic novel art, vibrant, highly detailed"
            # "best quality, high quality, cinematic film still, " + prompt + " . shallow depth of field, vignette, highly detailed, high budget, bokeh, cinemascope, moody, epic, gorgeous, film grain, grainy"
